...
import type {CategorizationInfo, MultiPackageInfo, ReleaseEntry} from './pr-description-updater'
...
import {appendSharedChangesetSections, updatePRDescription} from './pr-description-updater'
